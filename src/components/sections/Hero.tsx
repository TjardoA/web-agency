...
const Hero = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      ScrollTrigger.create({
        ...
        scrub: true,
        animation: gsap.to(".hero-card", { y: -28, ease: "none" })
      });
    }, heroRef);
  ...
  return (
    <section
      ref={heroRef}
      id="home"
      className="relative overflow-hidden px-4 pt-16 pb-14 sm:pt-20 sm:pb-18 lg:pt-24 lg:pb-20 bg-white"
    >
      <div className="hero-glow pointer-events-none absolute inset-0 -z-10 bg-gradient-to-br from-blue-200/40 via-white to-fuchsia-200/30 blur-3xl" />
